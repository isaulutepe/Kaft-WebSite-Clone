                                ...
                                >
                                    <SwiperSlide>
                                        ...
                                        <div style={{ position: 'relative', textAlign: 'center' }}>
                                            <img style={{ alt: 'bag', height: '400px', width: '350px' }} src={canta} />
                                            <div style={{
                                    ...
                                    <SwiperSlide>
                                        ...
                                        <div style={{ position: 'relative', textAlign: 'center' }}>
                                            <img style={{ alt: 'beanie', height: '400px', width: '350px' }} src={bere} />
                                            <div style={{
                                                position: 'absolute', top: '50%', left: '50%',
                                                transform: 'translate(-50%, -50%)',
                                                padding: '10px'
                                    ...
                                    <SwiperSlide>
                                        ...
                                        <div style={{ position: 'relative', textAlign: 'center' }}>
                                            <img style={{ alt: 'jacket', height: '400px', width: '350px' }} src={ceket} />
                                            <div style={{
                                                position: 'absolute', top: '50%', left: '50%',
                                                transform: 'translate(-50%, -50%)',
                                                padding: '10px'
                                    ...
                                    <SwiperSlide>
                                        ...
                                        <div style={{ position: 'relative', textAlign: 'center' }}>
                                            <img style={{ alt: 'tank', height: '400px', width: '350px' }} src={atlet} />
                                            <div style={{
                                                position: 'absolute', top: '50%', left: '50%',
                                                transform: 'translate(-50%, -50%)',
                                                padding: '10px'
                                    ...
                                    <SwiperSlide>
                                        <div style={{ position: 'relative', textAlign: 'center' }}>
                                            <img style={{ alt: 'short', height: '400px', width: '350px' }} src={short} />
                                            <div style={{
                                                position: 'absolute', top: '50%', left: '50%',
                                                transform: 'translate(-50%, -50%)',
                                                padding: '10px'
                                    ...
                                    <SwiperSlide>
                                        <div style={{ position: 'relative', textAlign: 'center' }}>
                                            <img style={{ alt: 'pant', height: '400px', width: '350px' }} src={pantolon} />
                                            <div style={{
                                                position: 'absolute', top: '50%', left: '50%',
                                                transform: 'translate(-50%, -50%)',
                                                padding: '10px'
